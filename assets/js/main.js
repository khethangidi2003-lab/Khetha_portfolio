...
(function() {
  ...
  /**
   * COMMENTED OUT: Init typed.js (spinning words animation)
   * This was showing: Full stack-Developer, UI/UX Designer, Data analyst
   */
  /*
  ...
  */
   ...
   * Added specifically for the projects section
   * ======================================== */
  ...
  function initProjectsAnimations() {
    ...
    cards.forEach(card => {
      card.addEventListener('mousemove', function(e) {
        ...
        const effect = this.querySelector('.project-hover-effect');
        if (effect) {
  ...
  window.addEventListener('DOMContentLoaded', initProjectsAnimations);

})();

// Add this to your JavaScript to debug
document.querySelectorAll('.social-links a').forEach(link => {
  link.addEventListener('click', function(e) {
    console.log('Social link clicked:', this.href);
    // If it's still not working, force navigation
